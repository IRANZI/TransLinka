    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy-950/50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-navy-500 focus:border-transparent"
                  value={form.name}
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 mb-6">Status</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Assigned route</label>
                <p className="rounded-lg border border-navy-100 bg-navy-50 px-4 py-2 text-sm text-navy-700">
                  {form.assignedRouteName || 'Not assigned yet'}
                </p>
                <p className="mt-1 text-xs text-navy-500">Assign coaches from Route management.</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Status *</label>
                <select
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-navy-500 focus:border-transparent bg-white"
                  value={form.status}
