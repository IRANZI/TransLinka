      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{bus.assignedRouteName || 'Not assigned yet'}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="text-xs text-navy-600 bg-navy-100 px-2 py-1 rounded">{bus.documents.vehicleRegistration}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 text-gray-400" />
                ...
                <span className="text-xs text-navy-600 bg-navy-100 px-2 py-1 rounded">{bus.documents.roadworthinessCertificate}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 text-gray-400" />
                ...
                <span className="text-xs text-navy-600 bg-navy-100 px-2 py-1 rounded">{bus.documents.insuranceCertificate}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 text-gray-400" />
                ...
                <span className="text-xs text-navy-600 bg-navy-100 px-2 py-1 rounded">{bus.documents.operatingLicense}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            ...
            <button className="px-6 py-2 bg-navy-600 text-white rounded-lg hover:bg-navy-700 transition-colors">
              Edit Bus Details
            </button>
          </div>
        </div>
